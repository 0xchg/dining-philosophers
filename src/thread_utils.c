...
/*   Updated: 2025/03/30 20:33:16 by mchingi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	safe_thread_handle(pthread_t *thread, void *(*foo)(void *), void *data, t_type thread_type)
{
	if (thread_type == T_CREATE)
		handle_thread_error(pthread_create(thread, NULL, foo, data), thread_type);
